 ...
 */
public class DatashareDescribeStep extends AbstractProcessingStep {

    private static final Logger log = org.apache.logging.log4j.LogManager.getLogger(DatashareDescribeStep.class);
    ...
    public DatashareDescribeStep() throws DCInputsReaderException {
